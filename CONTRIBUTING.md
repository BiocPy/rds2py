...
Welcome to `rds2py` contributor's guide.
...
If you experience bugs or general issues with `rds2py`, please have a look
...
You can help improve `rds2py` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`rds2py` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `rds2py`'s files. While this mechanism can
...
```
conda create -n rds2py python=3 six virtualenv pytest pytest-cov
conda activate rds2py
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/rds2py.git
   cd rds2py
   ```
...
5. Install [pre-commit]:
   ...
   `rds2py` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/rds2py
[issue tracker]: https://github.com/<USERNAME>/rds2py/issues
